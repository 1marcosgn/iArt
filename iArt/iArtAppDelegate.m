...
#import "iArtAppDelegate.h"

@implementation iArtAppDelegate
...
-(void) estiloHead{
    ...
    UIImage *navimage = [[UIImage imageNamed:@"orange.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
